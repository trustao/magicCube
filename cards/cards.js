 (function (win) {
        ...
        function Cards(options) {
            ...
            this.cards = []
            this.startBackFace = this.options.startBackFace || false
        ...
        Cards.prototype.init = function () {
            ...
            for(var i=0; i< 20; i++) {
                (function (i) {
                    ...
                    cardItem.className = 't-card-item' + (this.startBackFace?' rotate': '')
        ...
        Cards.prototype.contentInit = function () {
            contentDeal.call(this, 'frontContent')
            contentDeal.call(this, 'backContent')
            function contentDeal(key) {
                var contentData = this.options[key]
                if (!contentData) {
                    this[key] = function () {
                        return ''
                    }
                ...
                } else if (typeof contentData === 'function') {
                    this[key] = contentData
                } else if (Array.isArray(contentData)) {
                    this[key] = function (index) {
                        return contentData[index%contentData.length]
                    }
                } else {
                    console.error(key + 'illegal!')
                }
